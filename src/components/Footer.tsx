      ...
      <footer>
        <div className="row">
          <div className="col" style={{ width: "30%" }}>
            <div className="footer-logo" style={{display: "flex", gap: "12px"}}>
              <img
                src={`${logo}`}
                alt=""
                width={40}
          ...
          <div className="col" style={{ width: "16.66667%" }}>
            <div style={{ paddingTop: "12px", fontWeight: "bold", paddingBottom: "15px" }}>VỀ F8</div>
            <ul>
              <li>
                <a href="">Giới thiệu</a>
              </li>
          ...
          <div className="col" style={{ width: "16.66667%" }}>
            <div>
              <div style={{ paddingTop: "50px", fontWeight: "bold", paddingBottom: "15px" }}>
                SẢN PHẨM
              </div>
              <ul>
                <li>
          ...
          <div className="col" style={{ width: "16.66667%" }}>
            <div style={{ paddingTop: "84px", fontWeight: "bold", paddingBottom: "15px" }}>
              CÔNG CỤ
            </div>
            <ul>
              <li>
          ...
          <div className="col" style={{ width: "34%" }}>
            ...
            >
              ...
              <div>
                Lĩnh vực: Công nghệ, giáo dục, lập trình. <br />F8 xây dựng và
                phát triển những sản <br /> phẩm mang lại giá trị cho cộng đồng.
              </div>
            </div>
          </div>
        </div>
